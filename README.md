** documentation generated by IA...



# 🚀 Market Data Ingestor

A production-grade, high-performance market data ingestion system written in Go. Connects to multiple financial exchanges simultaneously, normalizes real-time market data, and distributes it via NATS/JetStream (can be change easely) with comprehensive control through gRPC/Protocol Buffers and REST APIs (for demo).
